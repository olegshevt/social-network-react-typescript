...
export const AddTweet: React.FC<AddTweetProps> = ({
  classes,
  maxRows,
  ...
  const textLimitPercent = Math.round((text.length / 150) * 100);
    ...
    <div>
      ...
      <div className={classes.addFormBottom}>
        ...
        <div className={classes.addFormBottomRight}>
          ...
          <Button onClick={handleClickAddTweet} color="primary" variant="contained">
            Твитнуть
          </Button>
        </div>
      </div>
